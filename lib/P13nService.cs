...
public partial class P13nService {
  public interface ISync {
    ...
    AutocompleteResponseBundle autocompleteAll(AutocompleteRequestBundle bundle);
    /// <summary>
  ...
  public interface Iface : ISync {
    ...
    #endif
    #if SILVERLIGHT
    IAsyncResult Begin_autocompleteAll(AsyncCallback callback, object state, AutocompleteRequestBundle bundle);
    AutocompleteResponseBundle End_autocompleteAll(IAsyncResult asyncResult);
    #endif
    /// <summary>
    /// Updating a choice or creating a new choice if choiceId is not given in choiceUpdateRequest.
    /// </summary>
  ...
  public class Client : IDisposable, Iface {
    ...
    #if SILVERLIGHT
    public IAsyncResult Begin_autocompleteAll(AsyncCallback callback, object state, AutocompleteRequestBundle bundle)
    {
      return send_autocompleteAll(callback, state, bundle);
    }

    public AutocompleteResponseBundle End_autocompleteAll(IAsyncResult asyncResult)
    {
      oprot_.Transport.EndFlush(asyncResult);
    ...
    public AutocompleteResponseBundle autocompleteAll(AutocompleteRequestBundle bundle)
    {
      #if !SILVERLIGHT
      ...
      #else
      var asyncResult = Begin_autocompleteAll(null, null, bundle);
      return End_autocompleteAll(asyncResult);

      #endif
    }
    #if SILVERLIGHT
    public IAsyncResult send_autocompleteAll(AsyncCallback callback, object state, AutocompleteRequestBundle bundle)
    #else
    public void send_autocompleteAll(AutocompleteRequestBundle bundle)
    #endif
    {
      oprot_.WriteMessageBegin(new TMessage("autocompleteAll", TMessageType.Call, seqid_));
    ...
    public AutocompleteResponseBundle recv_autocompleteAll()
    {
      TMessage msg = iprot_.ReadMessageBegin();
      if (msg.Type == TMessageType.Exception) {
        TApplicationException x = TApplicationException.Read(iprot_);
      ...
      throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "autocompleteAll failed: unknown result");
    }
  ...
  public class Processor : TProcessor {
    public Processor(ISync iface)
    {
      ...
      processMap_["autocompleteAll"] = autocompleteAll_Process;
    ...
    public void choose_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        oprot.WriteMessageBegin(new TMessage("choose", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void batchChoose_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("batchChoose", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void autocomplete_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("autocomplete", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void autocompleteAll_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      autocompleteAll_args args = new autocompleteAll_args();
      args.Read(iprot);
      iprot.ReadMessageEnd();
      ...
      try
      {
        try
        {
          result.Success = iface_.autocompleteAll(args.Bundle);
        }
        catch (P13nServiceException p13nServiceException)
        {
          result.P13nServiceException = p13nServiceException;
        }
        oprot.WriteMessageBegin(new TMessage("autocompleteAll", TMessageType.Reply, seqid)); 
        result.Write(oprot);
      }
      catch (TTransportException)
      {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("autocompleteAll", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void updateChoice_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("updateChoice", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
  ...
  [Serializable]
  #endif
  public partial class autocompleteAll_args : TBase
  {
    private AutocompleteRequestBundle _bundle;

    public AutocompleteRequestBundle Bundle
    {
      get
      {
        return _bundle;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case -1:
              if (field.Type == TType.Struct) {
                Bundle = new AutocompleteRequestBundle();
                Bundle.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("autocompleteAll_args");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
        if (Bundle != null && __isset.bundle) {
          field.Name = "bundle";
          field.Type = TType.Struct;
          field.ID = -1;
          oprot.WriteFieldBegin(field);
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("autocompleteAll_args(");
      bool __first = true;
      if (Bundle != null && __isset.bundle) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Bundle: ");
        __sb.Append(Bundle== null ? "<null>" : Bundle.ToString());
      }
      __sb.Append(")");
      return __sb.ToString();
    }
  ...
  [Serializable]
  #endif
  public partial class autocompleteAll_result : TBase
  {
    private AutocompleteResponseBundle _success;
    private P13nServiceException _p13nServiceException;

    public AutocompleteResponseBundle Success
    {
      get
      {
        return _success;
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.Struct) {
                Success = new AutocompleteResponseBundle();
                Success.Read(iprot);
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        TStruct struc = new TStruct("autocompleteAll_result");
        oprot.WriteStructBegin(struc);
        TField field = new TField();
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("autocompleteAll_result(");
      bool __first = true;
      if (Success != null && __isset.success) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
