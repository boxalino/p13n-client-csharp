          ...
          if (field.Type == TType.List) {
            {
              ...
              {
                FacetRequest _elem21;
                _elem21 = new FacetRequest();
                _elem21.Read(iprot);
                FacetRequests.Add(_elem21);
              }
              iprot.ReadListEnd();
            }
          } else { 
  ...
  public void Write(TProtocol oprot) {
    ...
    if (Filters != null && __isset.filters) {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (Filter _iter28 in Filters)
        {
          _iter28.Write(oprot);
        }
        oprot.WriteListEnd();
    ...
    if (FacetRequests != null && __isset.facetRequests) {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (FacetRequest _iter29 in FacetRequests)
        {
          _iter29.Write(oprot);
        }
        oprot.WriteListEnd();
    ...
    if (SortFields != null && __isset.sortFields) {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (SortField _iter30 in SortFields)
        {
          _iter30.Write(oprot);
        }
        oprot.WriteListEnd();
    ...
    if (ReturnFields != null && __isset.returnFields) {
      ...
      oprot.WriteFieldBegin(field);
      {
        ...
        foreach (string _iter31 in ReturnFields)
        {
